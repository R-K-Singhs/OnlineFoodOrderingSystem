...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location:seller_sign_up.php");
}
?>
...
<body>
    ...
    <div class="text-center">
        <a href="<?php echo $_SESSION["sprofileimg"]; ?>"> <img src="<?php echo $_SESSION["sprofileimg"]; ?>" width="200px" height="200px" class="rounded-circle border border-success " alt="..."></a>
        <div class=" text-center">
            ...
            <div class=" rounded container bg-warning border border-success p-3">
                <div class=" rounded container bg-secondary border border-success p-3">
                    <div class=" rounded container bg-light border border-success p-3">
                        <h4>Name: <span><?php echo $_SESSION["sname"]; ?></span></h4>
                        <hr>
                        <h4>Mobile Number: <span><?php echo $_SESSION["smobile"]; ?></span></h4>
                        <hr>
                        <h4>Date Of Birth: <span><?php echo $_SESSION["sdob"]; ?></span></h4>
                        <hr>
                        <h4>Email Id: <span><?php echo $_SESSION["semail"]; ?></span></h4>
                        <hr>
                        <h4>Shop Name: <span><?php echo $_SESSION["shopname"]; ?></span></h4>
                        <hr>
                        <h4>Shop Number: <span><?php echo $_SESSION["shopnum"]; ?></span></h4>
                        <hr>
                        <h4>Adharcard Number: <span><?php echo $_SESSION["adharcard"]; ?></span></h4>
                        <hr>
                        <h4>Pancard Number: <span><?php echo $_SESSION["pancard"]; ?></span></h4>
                        <hr>
                        <h4>Pincode : <span><?php echo $_SESSION["pincode"]; ?></span></h4>
                        <hr>
                        <h4>Shop Opening Time: <span><?php echo $_SESSION["sot"]; ?></span></h4>
                        <hr>
                        <h4>Shop Closing Time: <span><?php echo $_SESSION["sct"]; ?></span></h4>
                        <hr>
                        <h4>Address: <span><?php echo $_SESSION["saddress"]; ?></span></h4>
                    </div>
                </div>
            </div>
        </div>
